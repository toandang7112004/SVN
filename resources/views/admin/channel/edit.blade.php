                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" id="Category" method="post"
                                action="{{ route('channel.update',[$channel->id]) }}" enctype="multipart/form-data">
                                @method('PUT')
                                @csrf
                                <div class="tab-content">
                                    ...
                                    <div id="about" class="tab-pane active">
                                        ...
                                        <hr>
                                        <div class="form-group">
                                            <label for="name" class="col-lg-2 col-sm-2 control-label"> IP </label>
                                            <div class="col-lg-12">
                                        ...
                                        <hr>
                                        <div class="form-group">
                                            <label for="name" class="col-lg-2 col-sm-2 control-label"> Port </label>
                                            <div class="col-lg-12">
