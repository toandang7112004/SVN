            ...
            <section class="panel">
                <div class="panel-body">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" id="Category" method="post" action="{{ route('menu.store') }}" enctype="multipart/form-data">
                                @csrf
                                <div class="tab-content">
                                    ...
                                    <div id="about" class="tab-pane active">
                                        ...
                                        <hr>
                                        <div class="form-group">
                                            <label for="name" class="col-lg-2 col-sm-2 control-label">Giá Dịch
                                                Vụ</label>
                                            <div class="col-lg-12">
